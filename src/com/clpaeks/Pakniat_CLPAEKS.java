...
//Pakniat et al.'s CLPAEKS scheme
public class Pakniat_CLPAEKS {
    ...
    public static void keygen(String pairingParametersFileName, String idSender, String idReceiver, String mskFileName, String skFileName, String pkFileName, String ppFileName) throws NoSuchAlgorithmException {
        ...
        Element PK_Receiver = g.powZn(SK_Receiver_0).getImmutable();
        Element PK_Sender = g.powZn(SK_Sender_0).getImmutable();
    ...
    public static void encrypt(String pairingParametersFileName, String ppFileName, String keyword, String idSender, String idReceiver, String skFileName, String pkFileName, String ctFileName) throws NoSuchAlgorithmException {
        ...
        Element PK_Sender = bp.getG1().newElementFromBytes(Base64.getDecoder().decode(PK_Sender_String)).getImmutable();
        String PK_Receiver_String = pkProp.getProperty("PK_Receiver");
        Element PK_Receiver = bp.getG1().newElementFromBytes(Base64.getDecoder().decode(PK_Receiver_String)).getImmutable();
        ...
        //C2
        byte[] h1ID = merge(merge(idSender.getBytes(), PK_Sender.toBytes()),merge(idReceiver.getBytes(), PK_Receiver.toBytes()));
        byte[] h1Share = merge(kPairing.toBytes(), kPow.toBytes());
